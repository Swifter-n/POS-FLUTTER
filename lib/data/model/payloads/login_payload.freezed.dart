...
abstract class $LoginPayloadCopyWith<$Res> {
  ...
  @useResult
  $Res call({String credential, String password, String device_name});
}
...
class _$LoginPayloadImpl implements _LoginPayload {
  ...
  @override
  String toString() {
    return 'LoginPayload(credential: $credential, password: $password, device_name: $device_name)';
  }
  ...
  @override
  int get hashCode =>
      Object.hash(runtimeType, credential, password, device_name);
